...
defaultParams.kpx = 0.9#0.9 #0.4
defaultParams.kdx = 2.0#2.0 #1.4
defaultParams.kpy = 0.9
defaultParams.kdy = 2.0
defaultParams.kpz = 0.4 #0.09#0.09
defaultParams.kdz = 1.4 #0.20#0.20
defaultParams.quadMass = 1.8#0.605# Value determined experimetnally from scale - Actual SOLO mass is 1.5kg # (units in kg)
...
defaultParams.stoppingDistance =  0.25*0.75#defaultParams.targetAltitude*(1-0.75) # 0.75 says the stopping distance occurs when the drone is 75% of the target altitude 
