function flockingProcessor_log(Data,NeighSet,time)
...
for i = 1:length(time)
    qhati(:,i) = NeighSet(i,4:6,1) + Ts.*NeighSet(i,1:3,1);
    ...
    %# Guidance Term
    GT(:,i) = kGamma1*(Data(i,1:3,5)' - Data(i,1:3,4)') + kGamma2*([0;0;0] - Data(i,1:3,2)');
