...
Parameter = recordtype('Parameter',['Ts','peerTimeout','GPSTimeout','expectedMAVs','kp','kd','isComplete'], default = None)

RigidBodyState = recordtype('RigidBodyState', [('startTime', None),'ID','time','attitude',('RCLatch',False),('isGPS',False),('position',Position()),('velocity',Velocity()),('heading',0.0),('command',Command()),('parameters',Parameter()),('timeout',Timeout()),('control',ComputeControl()),('leader',Leader())], default = None)
